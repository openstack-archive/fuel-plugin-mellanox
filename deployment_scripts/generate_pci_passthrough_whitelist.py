...
# ["03:00.2","03:00.3","03:00.4","03:00.5","03:00.6","03:00.7"]
import sys
import subprocess
...
def main(exclude_vf_numbers, physnet):
  ...
  pci_res_str = "{0}{1}{2}".format('[',pci_res_str,']')
  pci_res_str = "{\"address\":{0}, \"physical_network\":\"{1}\"}".format(pci_res_str,physnet)
  print pci_res_str
  return pci_res_str
