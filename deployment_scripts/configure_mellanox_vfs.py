...
class MellanoxVfsSettings(object):
    ...
    def build_vfs_dict(cls):
        ...
        for pci_address in pci_res:
            ...
            if "00:00:00:00:00:00" in mac_list[count]:
    ...
    def unbind(cls):
        for vf in cls.mellanox_vfs:
            cmd_vfs_macs = "echo {0} ".format(vf['pci_address']) + \
            ...
            if retval != 0:
                ...
                logging.error("Failed to unbind mac address {0}".format(vf['pci_address']))
                sys.exit(1)
    ...
    def bind(cls):
        for vf in cls.mellanox_vfs:
            ...
            if retval != 0:
                ...
                logging.error("Failed to bind mac address {0}".format(vf['pci_address']) )
                sys.exit(1)
