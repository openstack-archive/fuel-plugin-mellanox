...
MLNX_DRIVERS_LIST = { 'ConnectX3': {'eth_driver' : 'mlx4_en', 'ib_driver' : 'eth_ipoib'},
                      'ConnectX4': {'eth_driver' : 'mlx5_core', 'ib_driver' : 'eth_ipoib'}}
          ...
          for card in MLNX_DRIVERS_LIST.keys():
            if drivers_set[0] in MLNX_DRIVERS_LIST[card].values():
              ...
              if 'eth' in network_driver_type:
                ...
                # to detect card check interface ibdev2netdev for any of the cloud interfaces
                command_get_cx_cards = "ibdev2netdev | grep -i up | grep %s | cut -d' ' -f1 ",\
                                        interfaces_set[0]
                ...
                if 'mlx5' in command_get_cx_cards:
                  mlnx['cx_card'] = 'ConnectX4'
                else:
                  mlnx['cx_card'] = 'ConnectX3'
